...
public sealed class BuildMacOSTask : FrostingTask<BuildContext>
{
    ...
    public override void Run(BuildContext context)
    {
        ...
        context.StartProcess("cmake", new ProcessSettings { WorkingDirectory = buildWorkingDir, Arguments = "-DCMAKE_OSX_DEPLOYMENT_TARGET=10.15 -DCMAKE_OSX_ARCHITECTURES=\"x86_64;arm64\" -DCMAKE_SHARED_LINKER_FLAGS=-Wl,-x CMakeLists.txt" });
